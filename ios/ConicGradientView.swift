...
@objc(ConicGradientView)
class ConicGradientView: UIView {
    ...
    func setupView(){
        mDrawable.setType(.conic)
        mDrawable.setStartPoint(CGPoint(x: 0.5, y: 0.5))
        mDrawable.setEndPoint(CGPoint(x: 1, y: 0.5))
    ...
    @objc func setConicRotation(_ v:NSNumber?){}
